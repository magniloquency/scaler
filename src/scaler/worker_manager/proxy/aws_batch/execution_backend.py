...
class AWSBatchExecutionBackend(TaskInputLoader, ExecutionBackend):
    ...
    def __init__(
        ...
        self._executor = ThreadPoolExecutor(max_workers=4, thread_name_prefix="aws-batch")
    ...
    def _initialize_aws_clients(self) -> None:
        ...
        logger.info(f"AWS Batch execution backend initialized: region={self._aws_region}, queue={self._job_queue}")
