...
from scaler.worker_manager.proxy.heartbeat_manager import HeartbeatManager
from scaler.worker_manager.proxy.mixins import ExecutionBackend, ProcessorStatusProvider
