...
class ConfigurationError(YMQException): ...
class SignalNotSupportedError(YMQException): ...
class CoreBugError(YMQException): ...
class RepetetiveIOSocketIdentityError(YMQException): ...
class RedundantIOSocketRefCountError(YMQException): ...
class MultipleConnectToNotSupportedError(YMQException): ...
class MultipleBindToNotSupportedError(YMQException): ...
class InitialConnectFailedWithInProgressError(YMQException): ...
class SendMessageRequestCouldNotCompleteError(YMQException): ...
class SetSockOptNonFatalFailureError(YMQException): ...
class IPv6NotSupportedError(YMQException): ...
...
class IOSocketStopRequestedError(YMQException): ...
class BinderSendMessageWithNoAddressError(YMQException): ...
class IPCOnWinNotSupportedError(YMQException): ...
class UVError(YMQException): ...
