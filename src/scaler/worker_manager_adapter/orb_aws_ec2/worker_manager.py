...
class ORBAWSEC2WorkerAdapter:
    ...
    def __init__(self, config: ORBAWSEC2WorkerAdapterConfig):
        ...
        self._worker_address = config.worker_manager_config.effective_worker_scheduler_address
...
nohup /usr/local/bin/scaler_worker_manager baremetal_native {self._worker_address.to_address()} \
    --mode fixed \
    --worker-type ORB \
